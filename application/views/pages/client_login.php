...
<body>
    ...
    <?php echo form_open('root/validate_client',['class'=>'openform']); ?>
    ...
    <p> Don't Have an Account ? <a href="<?php echo site_url('pages/client_signup'); ?>">Click here</a></p>
    <?php echo form_submit(['name'=>'submit','class'=>'submit','value'=>'Submit']);?>
    <?php echo form_close(); ?>
    </div>
